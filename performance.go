...
func GetPerformanceStandards() []PerformanceStandard {
	return []PerformanceStandard{
		...
		{"Public engagement", "Achieving a high level of public engagement through various means such as town hall meetings, social media, petitions, etc.", "Measure the level of engagement achieved by the MP or local counselor through metrics such as the number of town hall meetings held, the number of constituents reached through social media, or the number of petitions signed."},
